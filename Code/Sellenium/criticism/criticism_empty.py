...
class Criticism(unittest.TestCase):
    ...
    def test_criticism_empty_name(self):
        driver = self.driver
        driver.get(static_data.base_url + "criticism")
        fields.get_components_by_name(driver, ["family=fas", "email=smjfas@gmail.com",
                                               "message_topic=test", "message_body=This is a test message",
                                               "phonenumber=09398604014", "captcha=1234", "submit"])[6].click()

        assert driver.find_element_by_id("inValid") is not None

    def test_criticism_empty_family(self):
        driver = self.driver
        driver.get(static_data.base_url + "criticism")
        fields.get_components_by_name(driver, ["name=smj", "email=smjfas@gmail.com",
                                               "message_topic=test", "message_body=This is a test message",
                                               "phonenumber=09398604014", "captcha=1234", "submit"])[6].click()
    ...
    def test_criticism_empty_phone_num(self):
        driver = self.driver
        driver.get(static_data.base_url + "criticism")
        fields.get_components_by_name(driver, ["name=smj", "family=fas", "email=smjfas@gmail.com",
                                               "message_topic=test",
                                               "message_body=This is a test message",
                                               "captcha=1234", "submit"])[6].click()
