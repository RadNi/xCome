...
\item
شماره ملی باید اندازه‌ای درست (۱۰ رقم) داشته باشد در غیر این صورت سیستم پیام مناسب را به کاربر می‌دهد.
\item
شماره‌ی تلفن همراه باید اندازه و فرمتی مناسب داشته باشد در غیر این صورت سیستم پیام مناسب را به کاربر می‌دهد.
\item
در صورت وارد کردن دستورات SQL سیستم عملیات را انجام نمی‌دهد.
\end{itemize}
\end{tabular}
\\
 \hline
...
\begin{itemize}
\item
فیلد متن پیام نمی‌تواند خالی باشد.
\item
رایانامه باید فرمتی درست داشته باشد و در صورت وجود اشکال در فرمت رایانامه سیستم پیام مربوطه را به کاربر اعلام می‌کند.
\item
...
کاربر سامانه /کارمند/مدیر به صفحه‌ی فراموشی رمز عبور در سایت وارد می‌شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه /کارمند/مدیر ابتدا نحوه‌ی بازیابی را که می‌تواند از طریق تلگرام، پیامک یا ایمیل باشد را انتخاب می‌کنند. سپس شماره تلفن و رایانامه‌اش را وارد می‌کند. در نهایت با زدن دکمه‌ی submit می‌تواند رمز خود را بازیابی کند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
کاربر وارد صفحه‌ی انتقادات و پیشنهادات در سایت وارد می‌شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر با نوشتن نام و نام‌خانوادگی، رایانامه، عنوان و متن پیام، شماره همراه و در نهایت زدن دکمه‌ی register  انتقاد یا پیشنهاد خود را در سیستم ثبت می‌کند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\begin{itemize}
\item
رایانامه، عنوان، متن نمی‌توانند خالی باشد.
\item
فرمت رایانامه باید درست باشد.
\item
\lr{captcha}
...
۶ \\
 ...
 \textbf{توضیح اجمالی}
 &
کاربر سامانه می‌تواند حساب خود را شارژ کند.\\
 \hline
 \textbf{کنشگر اصلی}
 &
 کاربر سامانه \\
 ...
 \hline
  \textbf{شرایط اولیه}
 &
کاربر سامانه وارد صفحه‌ی شخصی خود در سامانه شوند.\\
 \hline
  \textbf{روند اصلی}
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه با زدن دکمه‌ی شارژ در صفحه‌ی خود و انتخاب مبلغ مورد نظر و زدن دکمه‌ی خرید حساب خود را شارژ می‌کنند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
 &
 \begin{tabular}{p{0.8\textwidth}@{}c@{}}
مبلغ شارژ شده به کیف پول کاربر واریز می‌شود. همچنین رسید تراکنش از طریقی که کاربر انتخاب کرده به او ارسال می‌گردد.
\end{tabular}
\\
\hline
  \textbf{سناریوی‌ فرعی}
...
کاربر سامانه / مدیر / کاربر وارد صفحه‌ی مشاهده‌ی اطلاعات شخصی خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کارمند / کاربر سامانه/مدیر می‌توانند برخی اطلاعات شخصی خود مانند شماره همراه رمز عبور یا رایانامه‌ی خود را ویرایش کنند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\item
در صورت استفاده از دستورات SQL سیستم عملیات را انجام نمی‌دهد.
\end{itemize}
\end{tabular}
\\
 \hline
...
کاربر سامانه / مدیر / کاربر وارد صفحه‌ی مشاهده‌ی تاریخچه‌ی تراکنش خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
در این صفحه جدولی از خلاصه‌ی تراکنش‌های انجام شده برای شخص نمایش داده خواهد شد.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\begin{tabular}{| c | c |} 
 \hline
\multicolumn{2}{|r|}{\textbf{پرداخت شهریه‌ی دانشگاه‌ها}} \\
 \hline
\textbf{شناسه} &
۱۰ \\
 \hline
 \textbf{توضیح اجمالی}
 &
کاربر سامانه می‌تواند به حساب دانشگاه مورد نظر خود پول واریز کند.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کاربر سامانه \\
...
کاربر سامانه وارد صفحه‌ی شخصی خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه می‌تواند با وارد کردن شماره حساب و مقدار پولی که می‌خواهند واریز کنند و همچنین نوع ارز، پس از مشاهده‌ی قیمت کارمزد، شهریه‌ی دانشگاه مورد نظر خود را پرداخت نماید. 
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
 &
 \begin{tabular}{p{0.8\textwidth}@{}c@{}}
تراکنش انجام می‌گیرد و رسید تراکنش از طریقی که کاربر سامانه انتخاب کرده به او اعلام می‌شود.
\end{tabular}
\\
\hline
  \textbf{سناریوی‌ فرعی}
...
\item
مبلغ مورد نظر باید از کف‌ای بیشتر و از سقفی کمتر باشد.
\item
انواع مختلف ارز شامل دلار، ریال و یورو است.
\item
در صورت استفاده از دستورات SQL سیستم تراکنش را انجام نمی‌دهد.
\end{itemize}
\end{tabular}
\\
 \hline
...
۱۱ \\
 ...
 \textbf{توضیح اجمالی}
 &
کاربر سامانه می‌تواند در آزمون‌های مختلف بین‌المللی ثبت نام کند.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کاربر سامانه \\
...
کاربر سامانه وارد صفحه‌ی شخصی خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه می‌تواند در صورت داشتن موجودی در کیف پول مورد نظر پس از مشاهده‌ی قیمت کل آزمون،‌مبلغی که لازم است را برای شرکت در آن آزمون پرداخت نماید.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
۱۲ \\
 ...
 \textbf{توضیح اجمالی}
 &
کاربر سامانه می‌تواند به صورت ناشناس به حساب شخص دیگری واریز داشته باشند.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کاربر سامانه \\
...
کاربر سامانه وارد صفحه‌ی شخصی خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه می‌تواند در صورت داشتن موجودی از نوع ارز مورد نظر با دادن شماره‌ی حساب شخص مورد نظر (آدرس کیف پول او در سایت) و مبلغ واریزی پس از مشاهده‌ی کارمزد به شماره حساب مورد نظر پول واریز کند.

اگر شخص مورد نظر در سامانه وجود نداشت از کاربر خواسته می‌شود فرمی مشابه فرم ثبت‌نام را برای کاربر پر کرده سپس به حساب او پول ریخته می‌شود.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
۱۳ \\
 ...
 \textbf{توضیح اجمالی}
 &
کاربر سامانه می‌تواند به حسابی در خارج از کشور پول واریز کند.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کاربر سامانه \\
...
کاربر سامانه  وارد صفحه‌ی شخصی خود در سامانه شوند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه می‌تواند در صورت داشتن موجودی از نوع ارز مورد نظر با دادن شماره‌ی حساب شخص مورد نظر و مبلغ واریزی پس از مشاهده‌ی کارمزد به شماره حساب مورد نظر پول واریز کند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
کارمند/مدیر به صفحه‌ی شخصی خود در سامانه وارد شده باشند.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کارمند/مدیر می‌تواند تراکنش‌هایی که در سیستم انجام شده است را با جزئیات آن مشاهده نماید. و آن را تایید یا رد کند.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\begin{tabular}{| c | c |} 
 \hline
\multicolumn{2}{|r|}{\textbf{استخدام کارمندان}} \\
 \hline
\textbf{شناسه} &
۱۸ \\
 \hline
...
۲۰ \\
 ...
 \textbf{توضیح اجمالی}
 &
تعیین روش ارتباطی سامانه با کاربرسامانه.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کاربر سامانه\\
 ...
 \hline
  \textbf{شرایط اولیه}
 &
کاربر سامانه به صفحه‌ی شخصی خود در سامانه وارد شده باشد.\\
 \hline
  \textbf{روند اصلی}
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
...
کاربر سامانه  به صفحه‌ی شخصی خود در سامانه وارد شده باشد.\\
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کاربر سامانه می‌تواند با توجه به قیمت لحظه‌ای ارزهای گوناگون دارایی‌های کیف پول‌های مختلف خود را به یکدیگر تبدیل کنند. در این تبدیل کارمزدی به حساب سامانه واریز می‌شود.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\begin{tabular}{| c | c |} 
 \hline
\multicolumn{2}{|r|}{\textbf{گزارش به مدیر}} \\
 \hline
\textbf{شناسه} &
۲۲ \\
 \hline
 \textbf{توضیح اجمالی}
 &
گزارش موارد مشکوک به مدیریت سامانه.\\
 \hline
 \textbf{کنشگر اصلی}
 &
کارمند \\
 ...
 \hline
  \textbf{شرایط اولیه}
 &
کارمند به صفحه‌ی شخصی خود در سامانه وارد شده باشد.\\
 \hline
  \textbf{روند اصلی}
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
کارمند می‌تواند در صورت مشاهده‌ی مورد مشکوکی در تراکنش‌ها آن را به صورت مستقیم در قالب پیامی با مدیر در میان بگذارد.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
 &
 \begin{tabular}{p{0.8\textwidth}@{}c@{}}
پیام برای مدیریت سامانه ارسال می‌شود.
\end{tabular}
\\
\hline
  \textbf{سناریوی‌ فرعی}
...
\begin{tabular}{| c | c |} 
 \hline
\multicolumn{2}{|r|}{\textbf{شارژ سامانه}} \\
 \hline
\textbf{شناسه} &
۲۳ \\
 \hline
...
مدیر \\
 ...
 \hline
  \textbf{شرایط اولیه}
 &
مدیر به صفحه‌ی شخصی خود در سایت وارد شده باشد.\\
 \hline
  \textbf{روند اصلی}
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
مدیر می‌تواند در صورت لزوم مبلغی را به حساب سامانه واریز کند و دارایی ارزی سامانه را شارژ نماید تا حقوق کارمندان و خرید ارز توسط کاربران سامانه انجام پذیرد.
\end{tabular}
\\
\hline
  \textbf{شرایط پایانی}
...
\hline
 ...
 &
\begin{tabular}{p{0.8\textwidth}@{}c@{}}
مبلغ شارژ باید معتبر باشد.(مثلا منفی نباشد)
\end{tabular}
\\
 \hline
\end{tabular}
